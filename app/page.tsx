    ...
    <div className="bg-gradient-to-b from-gray-900 to-indigo-900 text-white">
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div className="absolute inset-0 overflow-hidden pointer-events-none">
            ...
            <div className="absolute top-[15%] left-[10%] animate-float opacity-30">
              <img src={zodiacSvgMap['aries']} alt="Aries symbol" width={40} height={40} className="w-6 h-6 sm:w-8 sm:h-8 md:w-10 md:h-10 animate-shimmer" />
            </div>
            
            {/* Taurus - Bull symbol */}
            <div className="absolute top-[45%] left-[5%] animate-float-delayed opacity-30">
              <img src={zodiacSvgMap['taurus']} alt="Taurus symbol" width={40} height={40} className="w-5 h-5 sm:w-7 sm:h-7 md:w-9 md:h-9 animate-shimmer-delayed" />
            </div>
            
            {/* Gemini - Twins symbol */}
            <div className="absolute top-[25%] left-[85%] animate-float-reverse opacity-30">
              <img src={zodiacSvgMap['gemini']} alt="Gemini symbol" width={40} height={40} className="w-7 h-7 sm:w-9 sm:h-9 md:w-11 md:h-11 animate-shimmer-slow" />
            </div>
            
            {/* Cancer - Crab symbol */}
            <div className="absolute top-[65%] left-[80%] animate-float-slow opacity-30">
              <img src={zodiacSvgMap['cancer']} alt="Cancer symbol" width={40} height={40} className="w-6 h-6 sm:w-8 sm:h-8 md:w-10 md:h-10 animate-shimmer-delayed-slow" />
            </div>
            
            {/* Leo - Lion symbol */}
            <div className="absolute top-[8%] left-[40%] animate-float-delayed-slow opacity-30">
              <img src={zodiacSvgMap['leo']} alt="Leo symbol" width={40} height={40} className="w-7 h-7 sm:w-8 sm:h-8 md:w-10 md:h-10 animate-shimmer" />
            </div>
            
            {/* Virgo - Virgin symbol */}
            <div className="absolute top-[75%] left-[15%] animate-float-reverse-slow opacity-30">
              <img src={zodiacSvgMap['virgo']} alt="Virgo symbol" width={40} height={40} className="w-6 h-6 sm:w-7 sm:h-7 md:w-9 md:h-9 animate-shimmer-delayed" />
            </div>
            
            {/* Libra - Scales symbol */}
            <div className="absolute top-[18%] left-[65%] animate-float opacity-30">
              <img src={zodiacSvgMap['libra']} alt="Libra symbol" width={40} height={40} className="w-6 h-6 sm:w-8 sm:h-8 md:w-10 md:h-10 animate-shimmer-slow" />
            </div>
            
            {/* Scorpio - Scorpion symbol */}
            <div className="absolute top-[55%] left-[92%] animate-float-delayed opacity-30">
              <img src={zodiacSvgMap['scorpio']} alt="Scorpio symbol" width={40} height={40} className="w-7 h-7 sm:w-9 sm:h-9 md:w-11 md:h-11 animate-shimmer-delayed-slow" />
            </div>
            
            {/* Sagittarius - Archer symbol */}
            <div className="absolute top-[80%] left-[60%] animate-float-reverse opacity-30">
              <img src={zodiacSvgMap['sagittarius']} alt="Sagittarius symbol" width={40} height={40} className="w-6 h-6 sm:w-8 sm:h-8 md:w-10 md:h-10 animate-shimmer" />
            </div>
            
            {/* Capricorn - Goat symbol */}
            <div className="absolute top-[35%] left-[25%] animate-float-slow opacity-30">
              <img src={zodiacSvgMap['capricorn']} alt="Capricorn symbol" width={40} height={40} className="w-6 h-6 sm:w-7 sm:h-7 md:w-9 md:h-9 animate-shimmer-delayed" />
            </div>
            
            {/* Aquarius - Water Bearer symbol */}
            <div className="absolute top-[30%] left-[75%] animate-float-delayed-slow opacity-30">
              <img src={zodiacSvgMap['aquarius']} alt="Aquarius symbol" width={40} height={40} className="w-7 h-7 sm:w-8 sm:h-8 md:w-10 md:h-10 animate-shimmer-slow" />
            </div>
            
            {/* Pisces - Fish symbol */}
            <div className="absolute top-[65%] left-[40%] animate-float-reverse-slow opacity-30">
              <img src={zodiacSvgMap['pisces']} alt="Pisces symbol" width={40} height={40} className="w-7 h-7 sm:w-9 sm:h-9 md:w-11 md:h-11 animate-shimmer-delayed-slow" />
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 z-10">
          <div className="max-w-3xl mx-auto text-center">
            <div className="flex justify-center mb-4 sm:mb-6">
              <Sparkles size={60} className="text-purple-400 sm:w-20 sm:h-20" />
            </div>
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-3 sm:gap-4 px-2">
              <Link href="/natal-chart" className="w-full sm:w-auto bg-purple-600 hover:bg-purple-700 text-white font-bold py-3 px-6 sm:px-8 rounded-lg transition-colors flex items-center justify-center gap-2">
                <Star className="h-4 w-4 sm:h-5 sm:w-5" />
                <span className="text-sm sm:text-base">Naručite natalnu kartu</span>
              </Link>
              <Link href="#services" className="w-full sm:w-auto bg-transparent hover:bg-white/10 border border-white text-white font-bold py-3 px-6 sm:px-8 rounded-lg transition-colors flex items-center justify-center gap-2">
                <Sparkles className="h-4 w-4 sm:h-5 sm:w-5" />
                <span className="text-sm sm:text-base">Istražite usluge</span>
              </Link>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-purple-900">
        <div className="container mx-auto px-4 text-center">
          ...
          <Link href="/natal-chart" className="bg-white text-purple-900 hover:bg-gray-200 font-bold py-3 px-8 rounded-lg text-lg transition-colors inline-flex items-center">
            <Star className="mr-2 h-5 w-5" />
            <span>Naručite vašu natalnu kartu</span>
          </Link>
        </div>
      </section>
    </div>
